        ...
        <section class="container form-container">
            ...
            <form action="../../controller/c_aspirasi.php?action=add" method="POST">
                <div class="form-group flex">
                    ...
                    <input type="text" id="judul" name="judul" class="input-container" placeholder="Contoh: Kerusakan Fasilitas" required>
                </div>
                ...
                <input type="number" id="id_siswa" name="id_siswa" value="<?= $_SESSION['id'] ?>" class="input-container" hidden>
