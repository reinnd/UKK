...
<body>
    ...
    <main>
    <div class="container">
            <div class="box">tambah aspirasi</div>
        </div>
            ...
            <table>
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>wifi lemot</td>
                            <td>ini wifi lemot sangat. 1MBps pun tak dapat</td>
                            <td><span style="font-weight: 600;">proses</span></td>
                            <td>belum ada balasan</td>
                            <td>16 feb 2026</td>
                            <td>
                                <a href="#" class="edit btn-disabled">edit</a>
                                <a href="#" class="delete btn-disabled">hapus</a>
                            </td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>kipas rusak</td>
                            <td>kipas rusak banh</td>
