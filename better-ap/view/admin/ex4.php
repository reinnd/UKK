...
<head>
    ...
    <style>
        ...
        * {
        ...
        .btn-disabled {
            opacity: 0.3; /* Membuat tombol terlihat kabur */
            cursor: not-allowed;
  ...
  background-color: rgb(59, 78, 253);
  color: #000;
...
.box {
            border: transparent;
            background-color: var(--white-500); /* Ini sama dengan #efefef */
            border-radius: 8px;
            overflow-x: hidden;
            flex: 1;
            padding: 15px;
        ...
        /* Style tambahan khusus untuk form agar lebih rapi */
        .form-group {
        ...
        .form-control:focus {
            outline: none;
            border-color: #e6b5b5;
            box-shadow: 0 0 5px rgba(230, 181, 181, 0.5);
        }

        textarea.form-control {
            resize: vertical;
            min-height: 200px; /* Membuat textarea besar */
        }
...
<body>
    ...
    <nav>
        ...
        <a href="#" class="nav-button nav-button-active">aspirasi</a>
        <a href="#" class="nav-button ">Riwayat</a> 
    </nav>

    <main>
        <div class="container" style="display: block; max-width: 800px; margin-left: auto; margin-right: auto;">
            <h2 style="margin-bottom: 1.5rem; font-weight: 700;">Sampaikan Aspirasimu</h2>
            
            <form action="proses_simpan.php" method="POST">
                <div class="form-group">
                    <label for="topik">Topik</label>
                    <input type="text" id="topik" name="topik" class="form-control" placeholder="Contoh: Kerusakan Fasilitas" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="kategori" name="kategori" class="form-control" required>
                        ...
                        <option value="fasilitas_kelas">Fasilitas Kelas</option>
                ...
                <div class="form-group">
                    <label for="isi">Tulis aspirasimu</label>
                    <textarea id="isi" name="isi" class="form-control" placeholder="Ceritakan detail aspirasi atau keluhanmu di sini..." required></textarea>
                </div>
