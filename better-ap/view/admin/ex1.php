...
<head>
    ...
    <title>Dashboard Aspirasi - Anggota</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;900&display=swap" rel="stylesheet">
    <style>
        /* ================= PROP.CSS ================= */
        html {
            --header-height-base: 60px; /* Disesuaikan sedikit agar pas dengan gambar */
        ...
        /* ================= STYLE.CSS (Modified for single file) ================= */
        * {
            margin: 0;
            padding: 0;
        ...
        /* Buttons dari style.css kamu */
        .balas {
            border: 1px solid #333;
            border-radius: 5px;
            padding: 4px 10px;
            color: #fff; /* Disesuaikan agar teks terbaca */
            background-color: rgb(87, 105, 206);
            cursor: pointer;
            font-size: 14px;
        }
        ...
        .balas:hover, .delete:hover { opacity: 0.8; }
        ...
        /* Table prop dari style.css kamu */
        table {
...
<body>
    ...
    <nav>
        ...
        <a href="#" class="nav-button nav-button-active">Anggota</a>
